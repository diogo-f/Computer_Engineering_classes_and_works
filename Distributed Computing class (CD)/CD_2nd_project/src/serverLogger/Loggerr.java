...
public class Loggerr {
    ...
    public Loggerr(InitialData data) throws FileNotFoundException {
        this.data = data;
        this.nReindeers = data.getnReindeers();
        this.nElves = data.getnElfs();
        this.groupSize = data.getMaxElvesInGroup();
        ...
        this.endElfOperations = new boolean[data.getnElfs()];
