...
public class ServerCom {
    ...
    private ServerSocket listeningSocket = null;				//Socket de escuta   *    @serialField listeningSocket
    private Socket commSocket = null;					//Socket de comunicação   *    @serialField commSocket
    private int serverPortNumb;						//Número do port de escuta do servidor   *    @serialField serverPortNumb
    private ObjectInputStream in = null;					//Stream de entrada do canal de comunicação   *    @serialField in
    private ObjectOutputStream out = null;				//Stream de saída do canal de comunicação   *    @serialField out

    public ServerCom(int portNumb) {									//Instanciação de um canal de comunicação (forma 1).
        serverPortNumb = portNumb;					//@param portNumb número do port de escuta do servidor
    }

    public ServerCom(int portNumb, ServerSocket lSocket) {									//Instanciação de um canal de comunicação (forma 2).
        serverPortNumb = portNumb;					//@param portNumb número do port de escuta do servidor
        listeningSocket = lSocket;					//@param lSocket socket de escuta
    }
     ...
     */
    public ServerCom accept() throws SocketTimeoutException, SocketException {
