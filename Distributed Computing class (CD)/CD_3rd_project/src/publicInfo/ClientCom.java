...
public class ClientCom
{
   ...
   private String serverHostName = null;					//Nome do sistema computacional onde está localizado o servidor   *    @serialField serverHostName
   private final int serverPortNumb;							//Número do port de escuta do servidor   *    @serialField serverPortNumb
